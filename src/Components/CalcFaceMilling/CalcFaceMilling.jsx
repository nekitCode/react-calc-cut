...
// сливки
  ...
  feedOnTooth(e){
    ...
    console.log(this.state.feedOnToothValue );
  }
  ...
  feedPerRevolution() {
    this.setState({feedPerRevolutionValue: this.state.numberOfTeethValue * this.state.feedOnToothValue})
  }
  ...
  return (
    ...
    <div className="mode-table__line">Торцевое фрезерование</div>
      ...
      <ul className='calcTable'>
        ...
        <li className='calcTable__calc-item'>
          <div className='calcTable__desc ription'>Скорость резания</div>
